...
namespace test_Structures
{
    TEST(TestDate, Constructor_Default) {
        Date obj;
        EXPECT_EQ("00.00.0000", obj.get_date());
    }

    TEST(TestDate, Constructor_int) {
        Date obj1(12, 1, 2021);
        EXPECT_EQ("12.01.2021", obj1.get_date());

        Date obj2(30, 2, 2021);
        EXPECT_EQ("00.02.2021", obj2.get_date());

        Date obj3(32, 1, 2021);
        EXPECT_EQ("00.01.2021", obj3.get_date());

        Date obj4(12, 15, 2021);
        EXPECT_EQ("00.00.2021", obj4.get_date());

        Date obj5(12, 1, -2021);
        EXPECT_EQ("12.01.0000", obj5.get_date());

        Date obj6(32, 15, -2021);
        EXPECT_EQ("00.00.0000", obj6.get_date());
    }
    ...
    TEST(TestDate, SetDate_int) {
        ...
        EXPECT_EQ("12.01.2021", obj.get_date());

        obj.set_date(30, 2, 2021);
        EXPECT_EQ("00.02.2021", obj.get_date());

        obj.set_date(32, 1, 2021);
        EXPECT_EQ("00.01.2021", obj.get_date());

        obj.set_date(12, 15, 2021);
        EXPECT_EQ("00.00.2021", obj.get_date());

        obj.set_date(12, 1, -2021);
        EXPECT_EQ("12.01.0000", obj.get_date());

        obj.set_date(32, 15, -2021);
        EXPECT_EQ("00.00.0000", obj.get_date());

        obj.set_date(30, 2, 2002);
        EXPECT_EQ("00.02.2002", obj.get_date());
    ...
    TEST(TestTime, Constructor_Default) {
        Time obj;
        EXPECT_EQ("00:00", obj.get_time());
    }

    TEST(TestTime, Constructor_int) {
        Time obj1(12, 25);
        EXPECT_EQ("12:25", obj1.get_time());

        Time obj2(24, 60);
        EXPECT_EQ("00:00", obj2.get_time());

        Time obj3(-1, -1);
        EXPECT_EQ("00:00", obj3.get_time());

        Time obj4(23, 59);
        EXPECT_EQ("23:59", obj4.get_time());

        Time obj5(24, 59);
        EXPECT_EQ("00:59", obj5.get_time());

        Time obj6(25, 59);
        EXPECT_EQ("00:59", obj6.get_time());

        Time obj7(22, 60);
        EXPECT_EQ("22:00", obj7.get_time());
    }
    ...
    TEST(TestTime, SetDate_int) {
        ...
        obj.set_time(23, 59);
        EXPECT_EQ("23:59", obj.get_time());

        obj.set_time(24, 59);
        EXPECT_EQ("00:59", obj.get_time());

        obj.set_time(25, 59);
        EXPECT_EQ("00:59", obj.get_time());

        obj.set_time(22, 60);
        EXPECT_EQ("22:00", obj.get_time());
    }
    ...
    TEST(TestRegistrationNumber, Constructor_Default) {
        ...
        EXPECT_EQ("00-0000000", obj.get_reg());
    }

    TEST(TestRegistrationNumber, Constructor_int) {
        RegistrationNumber obj1(12, 3456789);
        EXPECT_EQ("12-3456789", obj1.get_reg());

        RegistrationNumber obj2(00, 0);
        EXPECT_EQ("00-0000000", obj2.get_reg());

        RegistrationNumber obj3(100, 34567891);
        EXPECT_EQ("00-0000000", obj3.get_reg());

        RegistrationNumber obj4(-1, -1);
        EXPECT_EQ("00-0000000", obj4.get_reg());

        RegistrationNumber obj5(2, 1020);
        EXPECT_EQ("02-0001020", obj5.get_reg());

        RegistrationNumber obj6(12, 353);
        EXPECT_EQ("12-0000353", obj6.get_reg());
    }
    ...
    TEST(TestRegistrationNumber, SetDate_int) {
        ...
        EXPECT_EQ("12-3456789", obj.get_reg());
        ...
        obj.set_reg(2, 1020);
        EXPECT_EQ("02-0001020", obj.get_reg());

        obj.set_reg(12, 353);
        EXPECT_EQ("12-0000353", obj.get_reg());
    }
    ...
    TEST(TestSchedule, Constructor_Default) {
        Schedule obj;
        EXPECT_EQ("00:00-00:00", obj.get_schedule());
    }
    ...
    TEST(TestSchedule, Constructor_Time) {
        ...
        Time t2(19, 00);
        Schedule obj(t1, t2);
        EXPECT_EQ("10:00-19:00", obj.get_schedule());
    }
    ...
    TEST(TestSchedule, Constructor_str) {
        ...
        EXPECT_EQ("10:00-18:00", obj.get_schedule());
    }
    ...
    TEST(TestSchedule, SetDate_Time) {
        ...
        Time t2(16, 00);
        Schedule obj(t1, t2);
        EXPECT_EQ("10:00-16:00", obj.get_schedule());
    }

    TEST(TestSchedule, SetDate_str) {
        Schedule obj;
        obj.set_schedule("12:00-15:00");
        EXPECT_EQ("12:00-15:00", obj.get_schedule());
    }
}
